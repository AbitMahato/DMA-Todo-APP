...
public class NewAdapter extends RecyclerView.Adapter<NewAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View notesRow = layoutInflater.inflate(R.layout.savednotes, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            this.NoteMeTitle = view.findViewById(R.id.notetitle);
            this.NoteMeDescription = view.findViewById(R.id.notedescription);
            this.container = view.findViewById(R.id.savednotes);
